...
model_name = "SwinTransformer3D_BRT_TD_"+str(clip_seg_num)+"x"+str(sample_rate)+"_breakfast_split" + str(split)
...
MODEL = dict(
    ...
    loss = dict(
        ...
        head_loss_cfg = dict(
            name = "RLPGSegmentationLoss", # RLPGSegmentationLoss SegmentationLoss
            num_classes = num_classes,
            smooth_weight = 0.0,
...
DATASET = dict(
    ...
    train = dict(
        ...
        videos_path = "./data/breakfast_2/Videos_mp4",
        sliding_window = sliding_window
    ),
    test = dict(
